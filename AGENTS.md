...
[workflow model](skills/init-authoritah/references/WORKFLOW.md) before changing its structure.
`examples/checkpoint/create` is an optional reference tool for safe checkpoint creation.
